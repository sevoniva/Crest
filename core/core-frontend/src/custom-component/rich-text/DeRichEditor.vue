...
const init = reactive({
  ...
  language_url: formatEmbeddedUrl('./tinymce-crest-private/langs/zh_CN.js'), // 语言包的路径，具体路径看自己的项目，文档后面附上中文js文件
  language: 'zh_CN', //语言
  skin_url: formatEmbeddedUrl('./tinymce-crest-private/skins/ui/oxide'), // skin路径，具体路径看自己的项目
  height: 400, //编辑器高度
  ...
  content_css: formatEmbeddedUrl('./tinymce-crest-private/skins/content/default/content.css'), //以css文件方式自定义可编辑区域的css样式，css文件需自己创建并引入
  //图片上传
